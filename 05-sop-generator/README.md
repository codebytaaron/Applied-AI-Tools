...
Turns a process description into an SOP with steps, QA checks, and a checklist.

## What it does
Given a process, outputs an SOP, roles, step-by-step, failure modes, and a copy-paste checklist.
