...
Generates reusable prompt packs for specific roles and tasks.

## What it does
Given a target role and use-cases, produce a polished prompt pack with examples and guardrails.
