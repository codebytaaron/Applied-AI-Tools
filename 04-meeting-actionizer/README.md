...
Turns messy notes/transcripts into decisions, owners, due dates, and next steps.

## What it does
Given notes, outputs a clean summary, decisions, action items with owners/dates, and risks/blockers.
