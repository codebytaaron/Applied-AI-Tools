...
Checks a draft against policy rules and surfaces risks and edits.

## What it does
Given policy text + a draft, outputs violations, severity, suggested edits, and a safe final version.
