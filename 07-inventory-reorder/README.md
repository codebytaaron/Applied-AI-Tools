...
Suggests reorder points and draft POs based on simple inputs.

## What it does
Given stock levels, lead times, and sales velocity, outputs reorder plan, risk items, and a PO draft.
